    ...
    with app.app_context():
        ...
        listings = [
            Listing(
                ...
                description=(
                    "Keep the studio clean while Tupac records his next hit! We"
                    " need someone who can handle late nights, occasional spills,"
                    " and keeping the vibe immaculate. Previous experience with"
            ...
            Listing(
                ...
                description=(
                    "Straight Outta Compton... into organic farming! Help us turn"
                    " vacant lots into thriving gardens. Volunteers will learn urban"
                    " agriculture while giving back to the community. Snoop Dogg"
            ...
            Listing(
                ...
                description=(
                    "Diddy needs help setting up for the next big party! Looking"
                    " for energetic volunteers to help with stage setup, lighting,"
                    " and making sure everything is on point. Must be able to lift"
            ...
            Listing(
                ...
                description=(
                    "2Pac is hosting poetry workshops for youth and needs teaching"
                    " assistants. Help inspire the next generation of spoken word"
                    " artists. Must love poetry, hip-hop culture, and have patience"
                    " with aspiring poets."
                ),
                location="Oakland, CA",
                owner_id=deathrow_user.id if deathrow_user else 1
            ...
            Listing(
                ...
                description=(
                    "Friday just got real! Help with independent film production,"
                    " from script reading to on-set assistance. Learn the business"
            ...
            Listing(
                ...
                description=(
                    "Notorious B.I.G. Memorial Food Truck serving the community."
                    " Need volunteers to help serve meals, take orders, and spread"
                    " love through good food. All meals served with extra Brooklyn"
            ...
            Listing(
                ...
                description=(
                    "Forgot About Dre? Never! Help organize music production"
                    " workshops for underprivileged youth. Assist with equipment"
                    " setup, student registration, and keeping the energy high."
            ...
            Listing(
                ...
                description=(
                    "Makaveli lives on through youth basketball! Organize pickup"
                    " games, coach fundamentals, and be a positive role model."
        ...
        volunteers = "Tupac, Snoop Dogg, Diddy, Ice Cube, Biggie, Dr. Dre"
        print(f"\nVolunteers mentioned: {volunteers}")
