...
class TestAchievementsEndpoint:
    ...
    def test_volunteer_achievements_with_interactions(self, client, volunteer_auth, sample_event):
...
class TestVolunteerGamification:
    ...
    def test_volunteer_earns_badges_through_actions(self, client, volunteer_auth, sample_event):
...
class TestOrganizationGamification:
    ...
    def test_organization_engagement_metrics(self, client, organization_auth, sample_event):
...
class TestGamificationIntegration:
    ...
    def test_volunteer_complete_gamification_journey(self, client, volunteer_auth, sample_event):
    ...
    def test_multiple_users_independent_progress(self, client):
        ...
        # Login both
        vol1_token = client.post('/login', json={
            'email': 'vol1@test.com',
            'password': 'password123'
        }).json['access_token']

        vol2_token = client.post('/login', json={
            'email': 'vol2@test.com',
            'password': 'password123'
        }).json['access_token']
